...
/* Min file (c) */
function updateId(a,b,c){angular.forEach(c,function(c,d){(angular.isDefined(c.properties)&&angular.isUndefined(c.properties.isIdUpdated)||angular.isDefined(c.properties)&&c.data.isIdUpdated===!1)&&(c.properties.id=(angular.isDefined(a)?a:"")+(angular.isDefined(b)?b:"")+c.properties.id,c.properties.diagnoseControlId=a,c.properties.isIdUpdated=!0),c.categorieschildren&&updateId(a,b,c.categorieschildren)})}function createDirective(a){function b(b,c,d,e,f){function g(a){var b=a.scope,c=a.iElem;"RadioGroup"===b.controls.type&&(d.processHierarchyLabelsForControl(b.controls,b.parent),processRadioGroup(b,e,f)),"CheckboxGroup"===b.controls.type&&(d.processHierarchyLabelsForContainer(b.controls,b.parent),processCheckboxGroup(b)),"RadioButton"===b.controls.type&&(b.controls.uniqueProperty=e.get("uniqueProperty")),"Checkbox"===b.controls.type&&(d.processHierarchyLabelsForControl(b.controls,b.parent),processCheckbox(b,e,c,f)),"TextInput"===b.controls.type&&(d.processHierarchyLabelsForControl(b.controls,b.parent),processTextInput(b,e,f)),"Text"===b.controls.type&&(e.set("TextLabel",b.controls.properties.text),b.controls.properties.label=b.controls.properties.text),"ToggleSwitch"===b.controls.type&&processToggleSwitch(b,e,f),"Slider"===b.controls.type&&processSlider(b,e,c,f),"Grid"===b.controls.type&&processGrid(b),"SelectMenu"===b.controls.type&&processSelectMenu(b,e,c,f),"Collapsible"===b.controls.type&&d.processHierarchyLabelsForContainer(b.controls,b.parent)}return{restrict:"E",scope:{controls:"=",groupname:"=",parent:"=",uniqueProperty:"@",tabHierarchyHeadings:"@",attachCategories:"@"},compile:function(d,f){return{pre:function(d,f,h){if("r"===a&&void 0!==d.uniqueProperty&&e.set("uniqueProperty",d.uniqueProperty),angular.isDefined(d.tabHierarchyHeadings)&&e.set("tabHierarchyHeadings",d.tabHierarchyHeadings),("true"===d.attachCategories||d.attachCategories===!0||d.controls.attachCategories===!0)&&(d.controls.attachCategories=!0,angular.forEach(d.controls.children,function(a,b){a.attachCategories=!0})),void 0!==d.controls&&null!==d.controls&&void 0!==d.controls.type){if("Tabs"===d.controls.type&&d.controls.categories&&angular.isDefined(d.attachCategories)&&d.attachCategories){var i="CategoriesButtonsStems"===d.controls.categories[0].type?d.controls.categories[0].categorieschildren:d.controls.categories;e.setClassificationData(i)}var j=c.get(d.controls.type),k={};k.scope=d,k.iElem=f,g(k);var l=angular.element(j);b(l)(d),f.append(l)}},post:function(a,b,c){setTimeout(function(){("Tabs"===a.controls.type||"TabRoot"===a.controls.type)&&("TabRoot"===a.controls.type&&$("#defaultPage").enhanceWithin(),b.tabs(),b.data("tabsInitialized",!0))},1),"Slider"===a.controls.type&&a.$on("$destroy",function(a){b.off("change")})}}}}}return b.$inject=["$compile","$templateCache","DirectiveHelperService","SharedDataService","ControlsService"],b}
//# sourceMappingURL=moduleHelperFunctions.js.map
/* Min file (c) */
!function(){"use strict";function a(a,b,c,d){var e=["Tabs","RadioGroup","CheckboxGroup","RadioButton","Checkbox","TextInput","Text","ToggleSwitch","Slider","Grid","SelectMenu","Collapsible","CollapsibleSet","Block","CategoriesButtons","CategoriesButtonsStems","CategoriesRoot","Content","Div","TabRoot"],f=[];d.setDeferedArray(f),angular.forEach(e,function(d,e){var g=c.defer();f.push(g.promise),b.get("/Components/UIComponents/templates/"+d+".html").success(function(b){a.put(d,b),g.resolve()})})}angular.module("ui",["data"]).run(a).directive("r",createDirective("r")).directive("tab",createDirective("tab")),a.$inject=["$templateCache","$http","$q","DirectiveCreateService"]}();
...
/* Min file (c) */
!function(){"use strict";function a(){var a={restrict:"A",scope:{},link:function(a,b,c){console.log("Role Directive")}};return a}a.$inject=[],angular.module("ui").directive("dataRole",a)}();
//# sourceMappingURL=RoleDirective.js.map
/* Min file (c) */
!function(){"use strict";angular.module("ui").directive("enhanceUi",[function(){return{restrict:"A",link:function(a,b,c){{var d=a.$eval(c.enhanceUi);d.event,d.condition}$("#defaultPage").enhanceWithin(),$(b.parent()).trigger("updatelayout").listview("refresh")}}}])}();
...
/* Min file (c) */
!function(){function a(a){function b(){c()}function c(b,c){return angular.isDefined(b)&&(g=b),angular.isDefined(c)&&(h=c),f=a.defer(),$.indexedDB(g,{schema:{1:function(a){var b=a.createObjectStore(h,{autoIncrement:!0});b.createIndex("itemId")}}}).done(function(){i=$.indexedDB(g).objectStore(h),f.resolve()}),f.promise}function d(b,c){var d=a.defer();return f.promise.then(function(){i.get(b).then(function(a){var b;b=angular.isDefined(c)?a[c]:a,d.resolve(b)},function(a,b){console.log("Could not add to appStore",a,b)})}),d.promise}function e(b,c){var d=a.defer();return f.promise.then(function(){i.put(c,b).then(function(){d.resolve(c)},function(a,b){console.log("Could not update data",a,b)})}),d.promise}var f,g="TCMD",h="appStore",i=null;b();var j={};return j.openDatabase=c,j.getValue=d,j.setValue=e,j}angular.module("db-service",[]).service("DBService",a),a.$inject=["$q"]}();
//# sourceMappingURL=DBService.js.map
/* Min file (c) */
!function(){function a(){return function(a,b,c){return _.filter(a,function(a){return a[b]===c})}}function b(a,b,c){function d(){h.values={},h.values.tabInfo=[{properties:{id:"rootId",type:"Root"},type:"Root",children:[]}],e(),f()}function e(){b.getValue("diagnoseTabModel").then(function(b){if(b){b.tabInfo&&a.scanAndUpdateDuplicateIds(b.tabInfo),h.values=b;var d=a.scanAndUpdateDuplicateIds(angular.copy(h.values.tabInfo));c.setControls(d)}})}function f(){a.fetchServiceValues().then(function(a){h.controlsServiceValues=a,angular.forEach(h.values.tabInfo[0].children,function(b,c){if(b.selectedList){var d=_.findIndex(a.lists,function(a){return a.listName===b.selectedList.listName});-1!==d&&(b.selectedList=a.lists[d])}b.categoriesList&&(d=_.findIndex(a.lists,function(a){return a.listName===b.categoriesList.listName}),-1!==d&&(b.categoriesList=a.lists[d]))}),setTimeout(function(){$("#defaultPage").enhanceWithin(),$("#diagnoseConfigSection select.selected-list").selectmenu("refresh")},1)})}var g=this,h=g.model={};g.initialize=d,d(),g.onChangeTabChoice=function(){},g.onFileInput=function(b){console.log("file",b.files);var c=$(b).attr("index"),d=new FileReader;d.onload=function(d){h.values.tabInfo[0].children[c].fileName=b.files[0].name,h.values.tabInfo[0].children[c].children&&a.removeIdsFromCacheList(h.values.tabInfo[0].children[c].children);var e=JSON.parse(d.target.result);a.scanAndUpdateDuplicateIds(e),h.values.tabInfo[0].children[c].children=e},d.readAsText(b.files[0])},g.onChangeList=function(a){h.values.tabInfo[0].children[a].children=h.values.tabInfo[0].children[a].selectedList.controls},g.onChangeCategories=function(a){var b=h.values.tabInfo[0].children[a].categoriesList.controls;h.values.tabInfo[0].children[a].categories=b;var c=[];_.deepMapValues(b,function(a,b){"label"===b[b.length-1]&&c.push(a)}),console.log(c),h.values.tabInfo[0].children[a].categoriesListArray=c},g.onDeleteDiagnoseTab=function(b){a.removeIdsFromCacheList(h.values.tabInfo[0].children[b].children),a.removeIdsFromCacheList(h.values.tabInfo[0].children[b].categories,"categorieschildren"),h.values.tabInfo.splice(b,1)},g.onAddDiagnoseTab=function(){h.values.tabInfo[0].children.push({tabName:"Diagnose Tab "+(h.values.tabInfo[0].children.length+1),type:"Tabs"}),setTimeout(function(){$("#defaultPage").enhanceWithin()},1)},g.onSaveDiagnoseConfig=function(){b.setValue("diagnoseTabModel",h.values);var d=a.scanAndUpdateDuplicateIds(angular.copy(h.values.tabInfo));c.setControls(d),ConfigTabFunctionality.setAppRefreshPending()}}angular.module("myapp.diagnose-config",["db-service"]).filter("property",a).controller("DiagnoseConfigController",b),b.$inject=["ControlsService","DBService","SharedDataService"]}();
...
/* Min file (c) */
!function(){function a(){var a={TEXT:0,BOOLEAN:1,SELECT:2};this.types=a;var b={},c=[{fieldName:"Id",fieldPath:"properties.id",fieldValue:"id1",fieldType:a.TEXT},{fieldName:"Label",fieldPath:"properties.label",fieldValue:"Label",fieldType:a.TEXT},{fieldName:"Value",fieldPath:"properties.value",fieldValue:"value",fieldType:a.TEXT},{fieldName:"Is Checked",fieldPath:"properties.isChecked",fieldValue:!1,fieldType:a.BOOLEAN},{fieldName:"Mini",fieldPath:"properties.mini",fieldValue:!0,fieldType:a.BOOLEAN},{fieldName:"Disabled",fieldPath:"properties.disabled",fieldValue:!1,fieldType:a.BOOLEAN,fieldOptions:[{display:"Disabled",value:!0},{display:"Enabled",value:!1}]}],d=[{fieldName:"Legend",fieldPath:"properties.legend",fieldValue:"",fieldType:a.TEXT},{fieldName:"Mini",fieldPath:"properties.mini",fieldValue:!0,fieldType:a.BOOLEAN},{fieldName:"Orientation",fieldPath:"properties.orientation",fieldValue:"vertical",fieldType:a.SELECT,fieldOptions:[{display:"horizontal",value:"horizontal"},{display:"vertical",value:"vertical"}]}],e=[{fieldName:"Text",fieldPath:"properties.text",fieldValue:"",fieldType:a.TEXT}],f=[{fieldName:"Id",fieldPath:"properties.id",fieldValue:"id1",fieldType:a.TEXT},{fieldName:"Label",fieldPath:"properties.label",fieldValue:"Label",fieldType:a.TEXT},{fieldName:"Value",fieldPath:"properties.value",fieldValue:0,fieldType:a.TEXT},{fieldName:"Min",fieldPath:"properties.min",fieldValue:0,fieldType:a.TEXT},{fieldName:"Max",fieldPath:"properties.max",fieldValue:100,fieldType:a.TEXT},{fieldName:"Step",fieldPath:"properties.step",fieldValue:1,fieldType:a.TEXT},{fieldName:"Mini",fieldPath:"properties.mini",fieldValue:!0,fieldType:a.BOOLEAN},{fieldName:"Highlight",fieldPath:"properties.highlight",fieldValue:!1,fieldType:a.BOOLEAN},{fieldName:"Disabled",fieldPath:"properties.disabled",fieldValue:!1,fieldType:a.BOOLEAN}],g=[{fieldName:"Id",fieldPath:"properties.id",fieldValue:"id1",fieldType:a.TEXT},{fieldName:"Value 1",fieldPath:"properties.value1",fieldValue:"no",fieldType:a.TEXT},{fieldName:"Value 2",fieldPath:"properties.value",fieldValue:"yes",fieldType:a.TEXT},{fieldName:"Label 1",fieldPath:"properties.label1",fieldValue:"No",fieldType:a.TEXT},{fieldName:"Label 2",fieldPath:"properties.label2",fieldValue:"Yes",fieldType:a.TEXT},{fieldName:"Mini",fieldPath:"properties.mini",fieldValue:!0,fieldType:a.BOOLEAN},{fieldName:"Disabled",fieldPath:"properties.disabled",fieldValue:!1,fieldType:a.BOOLEAN}],h=[{fieldName:"Id",fieldPath:"properties.id",fieldValue:"id1",fieldType:a.TEXT},{fieldName:"Value",fieldPath:"properties.value",fieldValue:"",fieldType:a.TEXT},{fieldName:"Type",fieldPath:"properties.type",fieldValue:"text",fieldType:a.SELECT,fieldOptions:[{display:"Text",value:"text"},{display:"Number",value:"number"},{display:"Date",value:"date"},{display:"Month",value:"month"},{display:"Week",value:"week"},{display:"Time",value:"time"},{display:"Date Time",value:"datetime-local"}]},{fieldName:"Hint",fieldPath:"properties.hint",fieldValue:"",fieldType:a.TEXT},{fieldName:"Label",fieldPath:"properties.label",fieldValue:"",fieldType:a.TEXT},{fieldName:"Native Control",fieldPath:"properties.nativecontrol",fieldValue:!1,fieldType:a.BOOLEAN},{fieldName:"Mini",fieldPath:"properties.mini",fieldValue:!0,fieldType:a.BOOLEAN},{fieldName:"Disabled",fieldPath:"properties.disabled",fieldValue:!1,fieldType:a.BOOLEAN}],i=[{fieldName:"Id",fieldPath:"properties.id",fieldValue:"id1",fieldType:a.TEXT},{fieldName:"Label",fieldPath:"properties.label",fieldValue:"Label",fieldType:a.TEXT}],j=[{fieldName:"Id",fieldPath:"properties.id",fieldValue:"id1",fieldType:a.TEXT}],k=[{fieldName:"Id",fieldPath:"properties.id",fieldValue:"id1",fieldType:a.TEXT},{fieldName:"Heading",fieldPath:"properties.heading",fieldValue:"Collapsible Area",fieldType:a.TEXT},{fieldName:"Collapsed",fieldPath:"properties.collapsed",fieldValue:!1,fieldType:a.BOOLEAN},{fieldName:"Icon Position",fieldPath:"properties.iconpos",fieldValue:"left",fieldType:a.SELECT,fieldOptions:[{display:"left",value:"left"},{display:"top",value:"top"},{display:"right",value:"right"},{display:"bottom",value:"bottom"},{display:"right",value:"right"}]},{fieldName:"Mini",fieldPath:"properties.mini",fieldValue:!0,fieldType:a.BOOLEAN},{fieldName:"Disabled",fieldPath:"properties.disabled",fieldValue:!1,fieldType:a.BOOLEAN,fieldOptions:[{display:"Disabled",value:!0},{display:"Enabled",value:!1}]}],l=[{fieldName:"Corners",fieldPath:"properties.corners",fieldValue:!1,fieldType:a.BOOLEAN},{fieldName:"Mini",fieldPath:"properties.mini",fieldValue:!0,fieldType:a.BOOLEAN},{fieldName:"Enable Filter",fieldPath:"properties.filter",fieldValue:!1,fieldType:a.BOOLEAN}],m=[{fieldName:"Mini",fieldPath:"properties.mini",fieldValue:!1,fieldType:a.BOOLEAN},{fieldName:"Label",fieldPath:"properties.label",fieldValue:"Label",fieldType:a.TEXT}],n=[{fieldName:"Label",fieldPath:"properties.label",fieldValue:"",fieldType:a.TEXT}];this.generate=function(a,o){var p=null;switch(a){case"Checkbox":case"RadioButton":p=angular.copy(c);break;case"CheckboxGroup":case"RadioGroup":p=angular.copy(d);break;case"Text":p=angular.copy(e);break;case"Slider":p=angular.copy(f);break;case"ToggleSwitch":p=angular.copy(g);break;case"TextInput":p=angular.copy(h);break;case"Filterable":p=angular.copy(j);break;case"Collapsible":p=angular.copy(k);break;case"CollapsibleSet":p=angular.copy(l);break;case"Tabs":p=angular.copy(i);break;case"SelectMenu":p=angular.copy(m);break;case"Option":p=angular.copy(n);break;default:return null}return _.deepMapValues({properties:o},function(b,c){if("properties"===c[0]){var d=c.join("."),e=_.pluck(p,"fieldPath").indexOf(d);-1!==e?p[e].fieldValue=b:p.push({fieldName:c[1],fieldPath:d,fieldValue:b,fieldType:a.TEXT})}return b}),angular.forEach(p,function(a,c){_.deepSet(b,a.fieldPath,a.fieldValue)}),p},this.getStructure=function(){return b}}angular.module("controls-module").service("FieldsGeneratorService",a),a.$inject=[]}();
//# sourceMappingURL=FieldsGeneratorService.js.map
/* Min file (c) */
!function(){function a(a,b,c){function d(a,b,c){if(angular.isUndefined(b)&&(b=A),"categories"===c&&(b.type="CategoriesButtonsStems"),-1!==_.pluck(E.lists,"listName").indexOf(a))return console.log("LOG to UI: list name already exists"),-1;var d={};d.listName=a,d.controls=[b],d.section=c,E.lists.push(d),E.selected.list=d,h()}function e(a){a<E.lists.length&&(E.selected.list=E.lists[a],E.selected.listIndex=a,h("selected"))}function f(a){E.selected.list.listName=a,E.lists[E.selected.listIndex].listName=a,h("selected"),h("lists")}function g(){return E.selected.list}function h(a){var b;void 0===b&&(b=C);var c=["controls","lists","selected","currentItemIndex","allListNames"];$.indexedDB(B).objectStore(D).get(b).then(function(d){var e=d;void 0!==a?d[a]=E[a]:angular.forEach(c,function(a,b){d[a]=E[a]}),$.indexedDB(B).objectStore(D).put(e,b).then(function(){$.indexedDB(B).objectStore(D).get(b).then(function(a){},function(a,b){console.log("Could not get back updated data")})},function(a,b){console.log("Could not update data")})},function(a,c){console.log("Could not select by key:",b)})}function i(){return E.controls}function j(){return E.selected}function k(a,b){if(angular.isArray(a))angular.forEach(a,function(a,c){k(a,b)});else{if(b=b?b:"children",angular.isDefined(a.properties))if(a.properties.id&&-1!==H.indexOf(a.properties.id)){if(a.properties.id="newItem"+ ++E.currentItemIndex,a.fieldsInfo){var c=_.filter(a.fieldsInfo,function(a){return"properties.id"===a.fieldPath});c.length>0&&(c[0].fieldValue=a.properties.id)}H.push(a.properties.id)}else a.properties.id&&-1===H.indexOf(a.properties.id)&&H.push(a.properties.id);angular.forEach(a[b],function(a,c){k(a,b)})}return a}function l(a,b){if(angular.isArray(a))angular.forEach(a,function(a,c){l(a,b)});else{if(b=b?b:"children",angular.isDefined(a)&&angular.isDefined(a.properties)){var c=H.indexOf(a.properties.id);a.properties.id&&-1!==c&&H.splice(c,1)}angular.isDefined(a)&&angular.forEach(a[b],function(a,c){l(a,b)})}return a}function m(a,b){if(angular.isArray(a))angular.forEach(a,function(a,c){m(a,b)});else{if(b=b?b:"children",angular.isDefined(a.properties)&&(angular.isUndefined(a.properties.isIdUpdated)||a.properties.isIdUpdated===!1)&&(a.properties.id="newItem"+ ++E.currentItemIndex,a.properties.isIdUpdated=!0,a.fieldsInfo)){var c=_.filter(a.fieldsInfo,function(a){return"properties.id"===a.fieldPath});c.length>0&&(c[0].fieldValue=a.properties.id)}angular.forEach(a[b],function(a,c){m(a,b)})}return a}function n(a){return I[a]}function o(a,b){var c=I[b];angular.isUndefined(a[c])&&(a[c]=[])}function p(a,b){var c={properties:{id:"newItem"+ ++E.currentItemIndex},type:b},d=I[a];return c[d]=[],c}function q(a,c,d,e){o(a,e);var f=p(e,d);switch(f.fieldsInfo=b.generate(d,f.properties),null!==f.fieldsInfo&&(f=$.extend(!0,{},b.getStructure(),f)),d){case"Checkbox":case"RadioButton":case"Slider":case"TextInput":case"Tabs":case"Option":f.properties.label=c;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.label"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=c;break}break;case"CheckboxGroup":case"RadioGroup":f.properties.legend=c;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.legend"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=c;break}break;case"Text":f.properties.text=c;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.text"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=c;break}break;case"Collapsible":f.properties.heading=c;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.heading"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=c;break}break;default:if(f.properties.label=c,null!==f.fieldsInfo&&angular.isDefined(f.fieldsInfo))for(var g=0;g<f.fieldsInfo.length;g++)if("properties.label"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=c;break}}var i=I[e];return a[i].push(f),E.selected.item=f,h(),f}function r(a){return-1!==G.indexOf(a)}function s(){return E}function t(){return c.getValue(C)}function u(a){F=a}function v(){return F}function w(){if(null!==F){var b=I[E.selected.list.section],c=m(angular.copy(F.$modelValue),b);F.$parentNodeScope.$modelValue[b].push(c),h(),a(function(){$("#defaultPage").enhanceWithin()},1)}}function x(a){var b=E.lists[a].listName;E.lists.splice(a,1),(E.selected.list.listName===b||E.lists.length<=0)&&(E.selected.list={}),h()}function y(){$.indexedDB("id-app").deleteDatabase()}var z={},A={type:"Content",zone:"content",properties:{id:"dummyId"},children:[],categorieschildren:[]},B="TCMD",C="serviceValues",D="appStore",E={controls:[],lists:[],selected:{list:null,listIndex:-1,item:null},currentItemIndex:0},F=null;$.indexedDB(B,{schema:{1:function(a){var b=a.createObjectStore(D,{autoIncrement:!0});b.createIndex("itemId")}}}).done(function(){$.indexedDB(B).objectStore(D).get(C).then(function(b){void 0===b?$.indexedDB(B).objectStore(D).put(E,C).then(function(){}):(E.lists=b.lists,null!==b.selected.list?E.selected.list=b.selected.list:null===E.selected.list&&b.lists.length>0&&null===b.selected.list&&(E.selected.list=b.lists[0],E.selected.listIndex=0,h("selected")),_.isNumber(b.currentItemIndex)&&!isNaN(b.currentItemIndex)?E.currentItemIndex=b.currentItemIndex:(E.currentItemIndex=0,h("currentItemIndex"))),$("#listNameInput").focus(),$("#listItemNameInput").focus(),a(function(){$("#defaultPage").enhanceWithin()},100)},function(a,b){console.log("Could not add to appStore")})}),z.createList=d,z.setSelectedList=e,z.setSelecedListName=f,z.getSelectedList=g,z.persistData=h;var G=["Tabs","RadioGroup","CheckboxGroup","Grid","SelectMenu","Collapsible","Block","Content","Div","TabRoot","Collapsible","CollapsibleSet","CategoriesButtons","CategoriesButtonsStems"];z.getControls=i,z.getSelected=j;var H=[];z.scanAndUpdateDuplicateIds=k,z.removeIdsFromCacheList=l,z.updateControlsId=m;var I={diagnose:"children",categories:"categorieschildren",personalData:"children"};return z.getChildNodeAttr=n,z.addNewSubItem=q,z.isContainer=r,z.getServiceValues=s,z.fetchServiceValues=t,z.setSelectedItemScope=u,z.getSelectedItemScope=v,z.duplicateSelectedItem=w,z.removeList=x,z.deleteDB=y,z}angular.module("controls-module").service("ControlsService",a),a.$inject=["$timeout","FieldsGeneratorService","DBService"]}();
//# sourceMappingURL=ControlsService.js.map
/* Min file (c) */
!function(){function a(a,b){var c=this;c.listName="";var d=c.model={listName:"",listNameEdit:!1,section:""};d.serviceValues=a.getServiceValues(),c.createList=function(){return""===d.listName?void b.setMessage(b.ENTER_LIST_NAME_MSG):""===d.section?void b.setMessage(b.SELECT_SECTION_MSG):-1===a.createList(d.listName,void 0,d.section)?void b.setMessage(b.LIST_EXISTS_MSG):void 0},c.onChangeSection=function(){},c.onRemoveList=function(b,c){b.stopPropagation(),a.removeList(c)},c.onSelectList=function(b){a.setSelectedList(b),d.listName=a.getSelectedList().listName,d.listNameEdit=!0},c.saveListName=function(){a.setSelecedListName(d.listName)},c.cancelSaveListName=function(){d.listNameEdit=!1}}angular.module("controlsTree").controller("CreateListController",a),a.$inject=["ControlsService","NotificationsService"]}();

...
/* Min file (c) */
"use strict";!function(){function a(){return function(a,b,c){return _.filter(a,function(a){return a[b]===c})}}function b(a,b,c,d,e,f){function g(){j.values={},j.values.tabInfo=[{properties:{id:"rootId"},type:"TabRoot",children:[]}],e.fetchServiceValuesFromDB().then(function(a){j.values=a}),h()}function h(){a.fetchServiceValues().then(function(a){j.controlsServiceValues=a,j.values.tabInfo.length>0&&angular.forEach(j.values.tabInfo[0].children,function(b,c){if(b.selectedList){var d=_.findIndex(a.lists,function(a){return a.listName===b.selectedList.listName});-1!==d&&(b.selectedList=a.lists[d])}b.categoriesList&&(d=_.findIndex(a.lists,function(a){return a.listName===b.categoriesList.listName}),-1!==d&&(b.categoriesList=a.lists[d]))}),setTimeout(function(){$("#defaultPage").enhanceWithin(),$("#diagnoseConfigSection select.selected-list").selectmenu("refresh")},1)})}var i=this,j=i.model={};i.initialize=g,g(),i.onChangeTabChoice=function(){},i.onFileInput=function(a,c){var d=function(d){j.values.tabInfo[0].children[c].fileName=a.files[0].name,j.values.tabInfo[0].children[c].children&&b.removeIdsFromCacheList(j.values.tabInfo[0].children[c].children);var e=null;try{e=JSON.parse(d.target.result),b.scanAndUpdateDuplicateIds(e),j.values.tabInfo[0].children[c].children=e}catch(f){}},e=new FileReader;e.addEventListener("load",d,!1),e.readAsText(a.files[0])},i.onChangeList=function(a){j.values.tabInfo[0].children[a].children=j.values.tabInfo[0].children[a].selectedList.controls},i.onChangeCategories=function(a){var b=j.values.tabInfo[0].children[a].categoriesList.controls;j.values.tabInfo[0].children[a].categories=b;var c=[];_.deepMapValues(b,function(a,b){"label"===b[b.length-1]&&c.push(a)}),j.values.tabInfo[0].children[a].categoriesListArray=c},i.onDeleteDiagnoseTab=function(a){b.removeIdsFromCacheList(j.values.tabInfo[0].children[a].children),b.removeIdsFromCacheList(j.values.tabInfo[0].children[a].categories,"categorieschildren"),j.values.tabInfo[0].children.splice(a,1)},i.onAddDiagnoseTab=function(){var a={properties:{label:"Diagnose Tab "+(j.values.tabInfo[0].children.length+1),id:b.generateUniqueId()},type:"Tabs"};j.values.tabInfo[0].children.push(a),setTimeout(function(){$("#defaultPage").enhanceWithin()},1)},i.onSaveDiagnoseConfig=function(){c.setValue("diagnoseConfigServiceValues",j.values);var a=b.scanAndUpdateDuplicateIds(angular.copy(j.values.tabInfo));d.setControls(a),angular.forEach(a[0].children,function(a,b){f.setTabOptions(a.properties.id,a)}),ConfigTabFunctionality.setAppRefreshPending()}}angular.module("myapp.diagnose-config",["controls-module","db-module","data"]).filter("property",a).controller("DiagnoseConfigController",b),b.$inject=["ControlsService","IdentityService","DBService","SharedDataService","DiagnoseConfigService","TabOptionsDataService"]}();
//# sourceMappingURL=DiagnoseConfigController.js.map
/* Min file (c) */
"use strict";!function(){function a(a,b,c,d,e,f){function g(){var g=a.defer();return d.getValue("diagnoseConfigServiceValues").then(function(a){if(a){a.tabInfo&&c.scanAndUpdateDuplicateIds(a.tabInfo),g.resolve(a);var d=c.scanAndUpdateDuplicateIds(angular.copy(a.tabInfo));e.findDeepestNode(d);var h=e.getDeepestNode();h&&h.properties&&(h.enhance=!0),angular.forEach(d[0].children,function(a,b){f.setTabOptions(a.properties.id,a)}),b.setControls(d)}}),g.promise}var h={};return h.fetchServiceValuesFromDB=g,h}angular.module("myapp.diagnose-config").service("DiagnoseConfigService",a),a.$inject=["$q","SharedDataService","IdentityService","DBService","ControlsService","TabOptionsDataService"]}();
//# sourceMappingURL=DiagnoseConfigService.js.map
/* Min file (c) */
!function(){function a(){return{restrict:"E",templateUrl:"AppCode/DiagnoseConfig/DiagnoseConfigTemplate.html"}}angular.module("myapp.diagnose-config").directive("diagnoseConfig",a)}();
//# sourceMappingURL=DiagnoseConfigDirective.js.map
/* Min file (c) */
!function(){function a(){var a={restrict:"E",templateUrl:"AppCode/DiagnoseConfig/TabOptionsTemplate.html",replace:!0};return a}angular.module("myapp.diagnose-config").directive("tabOptions",a)}();
...
(function () {
  angular.module('controls-module', ['db-module']);
}());
...
/* Min file (c) */
!function(){function a(a,b,c,d,e){function f(){d.getValue(E).then(function(a){return a&&a.error?void console.log("Error in reading Control service values from DB",a.error):(void 0===a?d.setValue(E,H).then(function(a){return a&&a.error?void console.log("Error in setting Control service values in DB",a.error):void G.resolve()}):(H.lists=a.lists,G.resolve()),$("#listNameInput").focus(),$("#listItemNameInput").focus(),void b(function(){$("#defaultPage").enhanceWithin()},100))})}function g(a,b,c){if(angular.isUndefined(b)&&(b=C),angular.isUndefined(c)&&(c="diagnose"),"categories"===c&&(b.type="CategoriesButtonsStems"),-1!==_.pluck(H.lists,"listName").indexOf(a))return-1;var d={};d.listName=a,d.controls=[b],d.section=c,H.lists.push(d),k()}function h(a){a=a?a:0,a<H.lists.length&&(H.selected.list=H.lists[a],H.selected.listIndex=a,k("selected"))}function i(a){H.selected.list.listName=a,H.lists[H.selected.listIndex].listName=a,k("selected"),k("lists")}function j(){return H.selected.list}function k(a){var b;void 0===b&&(b=E);var c=["controls","lists","selected","allListNames"];G.promise.then(function(){$.indexedDB(D).objectStore(F).get(b).then(function(d){var e=d;void 0!==a?d[a]=H[a]:angular.forEach(c,function(a,b){d[a]=H[a]}),$.indexedDB(D).objectStore(F).put(e,b).then(function(){$.indexedDB(D).objectStore(F).get(b).then(function(a){},function(a,b){console.log("Could not get back updated data")})},function(a,b){console.log("Could not update data")})},function(a,c){console.log("Could not select by key:",b)})})}function l(){return H.controls}function m(){return H.selected}function n(a){return K[a]}function o(a,b){var c=K[b];angular.isUndefined(a[c])&&(a[c]=[])}function p(a,b){var c={properties:{id:"newItem"+e.generateUniqueId()},type:b},d=K[a];return c[d]=[],c}function q(a,b,d,e){o(a,e);var f=p(e,d);switch(f.fieldsInfo=c.generate(d,f.properties),null!==f.fieldsInfo&&(f=$.extend(!0,{},c.getStructure(),f)),d){case"Checkbox":case"RadioButton":case"Slider":case"TextInput":case"Tabs":case"Option":f.properties.label=b;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.label"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}break;case"CheckboxGroup":case"RadioGroup":f.properties.legend=b;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.legend"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}break;case"Text":f.properties.text=b;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.text"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}break;case"Collapsible":f.properties.heading=b;for(var g=0;g<f.fieldsInfo.length;g++)if("properties.heading"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}break;default:if(f.properties.label=b,null!==f.fieldsInfo&&angular.isDefined(f.fieldsInfo))for(var g=0;g<f.fieldsInfo.length;g++)if("properties.label"===f.fieldsInfo[g].fieldPath){f.fieldsInfo[g].fieldValue=b;break}}var h=K[e];return a[h].push(f),H.selected.item=f,k(),f}function r(a){return-1!==J.indexOf(a)}function s(){return H}function t(){return d.getValue(E)}function u(a){I=a}function v(){return I}function w(){if(null!==I){var a=K[H.selected.list.section],c=updateControlsId(angular.copy(I.$modelValue),a);I.$parentNodeScope.$modelValue[a].push(c),k(),b(function(){$("#defaultPage").enhanceWithin()},1)}}function x(a){var b=H.lists[a].listName;H.lists.splice(a,1),H.selected.list&&H.selected.list.listName===b&&(H.selected.list={}),k()}function y(){$.indexedDB("id-app").deleteDatabase()}function z(a,b,c){return b||(b=0),c=c?c:"children",angular.isArray(a)?angular.forEach(a,function(a,d){b=z(a,b+1,c)}):(angular.isDefined(a.properties)&&(L=a),angular.forEach(a[c],function(a,d){b=z(a,b+1,c)})),b}function A(){return L}var B={},C={type:"Content",zone:"content",properties:{id:"dummyId"},children:[],categorieschildren:[]},D="TCMD",E="ControlServiceValues",F="appStore",G=a.defer(),H={controls:[],lists:[],selected:{list:null,listIndex:-1,item:null}},I=null;B.initialize=f,f(),B.createList=g,B.setSelectedList=h,B.setSelecedListName=i,B.getSelectedList=j,B.persistData=k;var J=["Tabs","RadioGroup","CheckboxGroup","Grid","SelectMenu","Collapsible","Block","Content","Div","TabRoot","Collapsible","CollapsibleSet","CategoriesButtons","CategoriesButtonsStems"];B.getControls=l,B.getSelected=m;var K={diagnose:"children",categories:"categorieschildren",personalData:"children"};B.getChildNodeAttr=n,B.addNewSubItem=q,B.isContainer=r,B.getServiceValues=s,B.fetchServiceValues=t,B.setSelectedItemScope=u,B.getSelectedItemScope=v,B.duplicateSelectedItem=w,B.removeList=x,B.deleteDB=y;var L=null;return B.findDeepestNode=z,B.getDeepestNode=A,B}angular.module("controls-module").service("ControlsService",a),a.$inject=["$q","$timeout","FieldsGeneratorService","DBService","IdentityService"]}();
//# sourceMappingURL=ControlsService.js.map
/* Min file (c) */
!function(){function a(){function a(a){return d[a]}function b(a,b){d[a]=b}var c={},d={};return c.getTabOptions=a,c.setTabOptions=b,c}angular.module("controls-module").service("TabOptionsDataService",a)}();
//# sourceMappingURL=TabOptionsDataService.js.map
/* Min file (c) */
!function(){function a(a,b,c){function d(a,b){a.heirarchyLabels||(a.heirarchyLabels=[]),a.heirarchyLabels=(angular.isDefined(b)&&angular.isDefined(b.heirarchyLabels)?angular.copy(b.heirarchyLabels):[]).concat(a.heirarchyLabels);var c=e(a);c&&a.heirarchyLabels.push(c)}function e(a){return"Collapsible"===a.type&&a.properties.heading?a.properties.heading:"CheckboxGroup"===a.type&&a.name?a.name:void 0}function f(a,b){angular.isUndefined(b)||(a.heirarchyLabels=b.heirarchyLabels?angular.copy(b.heirarchyLabels):[])}function g(b){a.set("RadioGroupCount",a.get("RadioGroupCount")+1),b.controls.groupname="RadioGroup"+a.get("RadioGroupCount"),b.controls.labelPrefix=a.get("tabHierarchyHeadings"),b.controls.name=b.controls.properties.legend,void 0===b.controls.properties.id&&(b.controls.properties.id="RadioGroup"+a.get("RadioGroupCount"));var d=c.getTabOptions(b.controls.properties.tabId);if(b.$watch("controls.value",function(c,e){if(void 0!==c){var f={controlId:b.controls.properties.id,label:b.controls.labelPrefix+b.controls.properties.legend,heirarchyLabels:b.controls.heirarchyLabels,type:b.controls.type,valueLabel:b.controls.value,value:b.controls.value,labelPrefix:b.controls.labelPrefix,categoriesInfo:b.controls.categorieschildren};createControlLabel(f),a.get("SelectedControls")[b.controls.properties.id]=f,b.controls.showCategory=!0,a.setRecentlySelectedControlDetails(f),!a.getIsControlsValuesBeingSet()&&b.controls.attachCategories&&d&&d.properties.useClassificationPanelInput&&openPanel()}else delete a.get("SelectedControls")[b.controls.properties.id],b.controls.showCategory=!1,a.setRecentlySelectedControlDetails(void 0)}),b.controls.attachCategories&&d&&d.properties.useClassificationPanelInput){var e=angular.copy(d.categoriesList.controls[0].categorieschildren);updateId(b.controls.properties.id,a.get("uniqueProperty"),e),a.get("ClassificationDataAdded").push({controlId:b.controls.properties.id,uniqueProperty:a.get("uniqueProperty"),classification:e}),b.controls.categorieschildren=e}}function h(a){a.controls.name=a.controls.properties.legend,angular.forEach(a.controls.children,function(b,c){b.name=a.controls.name})}function i(b,d){var e=a.get("uniqueProperty");b.controls.uniqueProperty=angular.isDefined(e)?e:"",b.controls.properties.id=b.controls.uniqueProperty+b.controls.properties.id,b.controls.labelPrefix=a.get("tabHierarchyHeadings");var f=c.getTabOptions(b.controls.properties.tabId);if(b.controls.attachCategories&&f&&f.properties.useClassificationPanelInput){var g=angular.copy(f.categoriesList.controls[0].categorieschildren);updateId(b.controls.properties.id,a.get("uniqueProperty"),g),a.get("ClassificationDataAdded").push({controlId:b.controls.properties.id,uniqueProperty:a.get("uniqueProperty"),classification:g}),b.controls.categorieschildren=g}b.$watch("controls.value",function(c,d){if(c!==!0||d!==!1&&void 0!==d)c===!1&&d===!0&&(void 0!==a.get("SelectedControls")[b.controls.properties.id]&&delete a.get("SelectedControls")[b.controls.properties.id],b.controls.showCategory=!1,a.setRecentlySelectedControlDetails(void 0));else{var e={controlId:b.controls.properties.id,label:b.controls.name?b.controls.name:"",heirarchyLabels:b.controls.heirarchyLabels,type:b.controls.type,valueLabel:b.controls.properties.label,labelPrefix:b.controls.labelPrefix,value:b.controls.value,categoriesInfo:b.controls.categorieschildren};createControlLabel(e),a.get("SelectedControls")[b.controls.properties.id]=e,b.controls.showCategory=!0,a.setRecentlySelectedControlDetails(e),!a.getIsControlsValuesBeingSet()&&b.controls.attachCategories&&f&&f.properties.useClassificationPanelInput&&openPanel()}})}function j(b,d){b.controls.value=0;var e=a.get("uniqueProperty");b.controls.uniqueProperty=angular.isDefined(e)?e:"",b.controls.properties.id=b.controls.uniqueProperty+b.controls.properties.id,b.controls.labelPrefix=a.get("tabHierarchyHeadings");var f=c.getTabOptions(b.controls.properties.tabId);if(d.on("change",'input[type="number"]',function(){var c=parseInt($(this).val());if(!(0>=c)){b.controls.value=c;var d={controlId:b.controls.properties.id,label:b.controls.properties.label,type:b.controls.type,valueLabel:b.controls.value,labelPrefix:b.controls.labelPrefix,value:b.controls.value,categoriesInfo:b.controls.categorieschildren};createControlLabel(d),a.get("SelectedControls")[b.controls.properties.id]=d,a.setRecentlySelectedControlDetails(d),b.controls.showCategory=!0,!a.getIsControlsValuesBeingSet()&&b.controls.attachCategories&&f&&f.properties.useClassificationPanelInput&&openPanel(),b.$apply()}}),b.controls.attachCategories&&f&&f.properties.useClassificationPanelInput){var g=angular.copy(f.categoriesList.controls[0].categorieschildren);updateId(b.controls.properties.id,e,g),a.get("ClassificationDataAdded").push({controlId:b.controls.properties.id,uniqueProperty:e,classification:g}),b.controls.categorieschildren=g}}function k(b){var d=a.get("uniqueProperty");b.controls.uniqueProperty=d,b.controls.properties.id=d+b.controls.properties.id,b.controls.labelPrefix=a.get("tabHierarchyHeadings");var e=c.getTabOptions(b.controls.properties.tabId);if(b.$watch("controls.value",function(c,d){if(void 0!==c&&""!==c){var f={controlId:b.controls.properties.id,label:b.controls.properties.label,type:b.controls.type,valueLabel:b.controls.value,labelPrefix:b.controls.labelPrefix,value:b.controls.value,categoriesInfo:b.controls.categorieschildren};createControlLabel(f),a.get("SelectedControls")[b.controls.properties.id]=f,b.controls.showCategory=!0,a.setRecentlySelectedControlDetails(f),!a.getIsControlsValuesBeingSet()&&b.controls.attachCategories&&e&&e.properties.useClassificationPanelInput&&openPanel()}else void 0!==a.get("SelectedControls")[b.controls.properties.id]&&delete a.get("SelectedControls")[b.controls.properties.id],b.controls.showCategory=!1,a.setRecentlySelectedControlDetails(void 0)}),b.controls.attachCategories&&e&&e.properties.useClassificationPanelInput){var f=angular.copy(e.categoriesList.controls[0].categorieschildren);updateId(b.controls.properties.id,d,f),a.get("ClassificationDataAdded").push({controlId:b.controls.properties.id,uniqueProperty:d,classification:f}),b.controls.categorieschildren=f}}function l(b){a.set("SliderCount",a.get("SliderCount")+1),void 0===b.controls.properties.id&&(b.controls.properties.id="ToggleSwitch"+a.get("SliderCount")),(void 0===b.controls.properties.label||""===b.controls.properties.label)&&(b.controls.properties.label=a.get("TextLabel")),a.set("TextLabel","");var d=a.get("uniqueProperty");b.controls.uniqueProperty=angular.isDefined(d)?d:"",b.controls.properties.id=b.controls.uniqueProperty+b.controls.properties.id,b.controls.labelPrefix=a.get("tabHierarchyHeadings");var e=c.getTabOptions(b.controls.properties.tabId);if(b.controls.value="false",b.$watch("controls.value",function(c,d){if("true"===c&&"false"===d){var f={controlId:b.controls.properties.id,label:b.controls.properties.label,type:b.controls.type,valueLabel:b.controls.properties.label1,labelPrefix:b.controls.labelPrefix,value:b.controls.value,categoriesInfo:b.controls.categorieschildren};createControlLabel(f),a.get("SelectedControls")[b.controls.properties.id]=f,b.controls.showCategory=!0,a.setRecentlySelectedControlDetails(f),!a.getIsControlsValuesBeingSet()&&b.controls.attachCategories&&e&&e.properties.useClassificationPanelInput&&openPanel()}else"false"===c&&(delete a.get("SelectedControls")[b.controls.properties.id],b.controls.showCategory=!1,a.setRecentlySelectedControlDetails(void 0))}),b.controls.attachCategories&&e&&e.properties.useClassificationPanelInput){var f=angular.copy(e.categoriesList.controls[0].categorieschildren);updateId(b.controls.properties.id,d,f),a.get("ClassificationDataAdded").push({controlId:b.controls.properties.id,uniqueProperty:d,classification:f}),b.controls.categorieschildren=f}}function m(a){var b=a.controls,c=b.properties&&b.properties.rows?b.properties.rows:1;void 0===b.properties&&(b.properties={}),b.properties.uiClass=GridBuilder.getGridClass(b.children,c),GridBuilder.setGridControlLabels(b)}function n(b,d){a.set("SelectMenuCount",a.get("SelectMenuCount")+1),void 0===b.controls.properties.id&&(b.controls.properties.id="SelectMenu"+a.get("SelectMenuCount")),b.controls.labelPrefix=a.get("tabHierarchyHeadings"),b.controls.properties.options&&b.controls.properties.options.children&&(b.controls.previousValue=b.controls.value=b.controls.defaultValue=b.controls.properties.options.children[0].value,b.controls.previousValueLabel=b.controls.valueLabel=b.controls.defaultValueLabel=b.controls.properties.options.children[0].text);var e=c.getTabOptions(b.controls.properties.tabId);if(d.on("change","select.control",function(c){var d=$(this).val(),f=$('option[value="'+d+'"]:selected',$(this)).text();if(d!==b.controls.previousValue&&d!==b.controls.defaultValue||f!==b.controls.previousValueLabel&&f!==b.controls.defaultValueLabel){b.controls.previousValue=b.controls.value,b.controls.previousValueLabel=b.controls.valueLabel,b.controls.value=d,b.controls.valueLabel=f;var g={controlId:b.controls.properties.id,label:b.controls.properties.label||b.controls.properties.options.label,type:b.controls.type,valueLabel:b.controls.valueLabel,labelPrefix:b.controls.labelPrefix,value:b.controls.value,categoriesInfo:b.controls.categorieschildren};createControlLabel(g),a.get("SelectedControls")[b.controls.properties.id]=g,b.controls.showCategory=!0,a.setRecentlySelectedControlDetails(g),!a.getIsControlsValuesBeingSet()&&b.controls.attachCategories&&e&&e.properties.useClassificationPanelInput&&openPanel()}else delete a.get("SelectedControls")[b.controls.properties.id],b.controls.showCategory=!1,a.setRecentlySelectedControlDetails(void 0);b.$digest()}),b.controls.attachCategories&&e&&e.properties.useClassificationPanelInput){var f=angular.copy(e.categoriesList.controls[0].categorieschildren);updateId(b.controls.properties.id,a.get("uniqueProperty"),f),a.get("ClassificationDataAdded").push({controlId:b.controls.properties.id,uniqueProperty:a.get("uniqueProperty"),classification:f}),b.controls.categorieschildren=f}}var o={};return o.processHierarchyLabelsForContainer=d,o.processHierarchyLabelsForControl=f,o.processRadioGroup=g,o.processCheckboxGroup=h,o.processCheckbox=i,o.processSlider=j,o.processTextInput=k,o.processToggleSwitch=l,o.processGrid=m,o.processSelectMenu=n,o}angular.module("controls-module").service("DirectiveHelperService",a),a.$inject=["SharedDataService","ControlsService","TabOptionsDataService"]}();
//# sourceMappingURL=DirectiveHelperService.js.map
/* Min file (c) */
!function(){function a(a,b,c){function d(){f=e.model={listName:"",listNameEdit:!1,section:"",selectedListIndex:null},f.controlsServiceValues=a.getServiceValues(),f.listSectionServiceValues=b.getServiceValues()}var e=this,f=e.model={};d(),e.createList=function(){return""===f.listName?void c.setMessage(c.ENTER_LIST_NAME_MSG):""===f.section?void c.setMessage(c.SELECT_SECTION_MSG):-1===a.createList(f.listName,void 0,f.section)?void c.setMessage(c.LIST_EXISTS_MSG):void 0},e.onChangeSection=function(){},e.onRemoveList=function(b){b.stopPropagation(),null!==f.selectedListIndex&&(a.removeList(f.selectedListIndex),e.selectedListName="")},e.onSelectList=function(){f.selectedListIndex=_.pluck(f.controlsServiceValues.lists,"listName").indexOf(e.selectedListName)},e.loadList=function(){console.log(f.selectedListIndex),null!==f.selectedListIndex&&(a.setSelectedList(f.selectedListIndex),f.listName=a.getSelectedList().listName,f.listNameEdit=!0,setTimeout(function(){$("#defaultPage").enhanceWithin()},1))},e.saveListName=function(){a.setSelecedListName(f.listName)},e.cancelSaveListName=function(){f.listNameEdit=!1}}angular.module("list-section-module",["notifications-module"]).controller("CreateListController",a),a.$inject=["ControlsService","ListSectionService","NotificationsService"]}();

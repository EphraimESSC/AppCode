...
/* Min file (c) */
!function(){function a(a,b,c){function d(){c.getValue("ClientDataServiceValues").then(function(a){a&&(r.clientsData.push.apply(r.clientsData,a.clientsData),r.nextClientId=a.nextClientId)})}function e(){return r}function f(){if(""===r.selectedClient.clientName)return-1;var a={clientId:r.nextClientId,clientName:r.selectedClient.clientName,clientAge:r.selectedClient.clientAge,birthdateAndHour:r.selectedClient.birthdateAndHour,clientGender:r.selectedClient.clientGender,clientPhone:r.selectedClient.clientPhone,clientAddress:r.selectedClient.clientAddress,nextDiagnoseId:1,diagnoseData:[]};return r.clientsData.push(a),r.nextClientId++,c.setValue("ClientDataServiceValues",r),r.clientsData.length}function g(a){r.clientsData.splice(a,1),c.setValue("ClientDataServiceValues",r)}function h(a){var b=_.find(r.clientsData,function(b){return b.clientId===a});return b}function i(a,b,d){var e=j(b),f=h(a),g="Diagnose: "+f.nextDiagnoseId+", "+(new Date).toLocaleString(),i={diagnoseId:f.nextDiagnoseId,diagnoseName:g,selectedControlsDetails:angular.copy(b),categoriesArray:e,imageCollectionHolder:d};f.nextDiagnoseId++,f.diagnoseData.push(i),c.setValue("ClientDataServiceValues",r)}function j(a){var b={};angular.forEach(a,function(a,c){a.finalCategorizationArrays&&a.finalCategorizationArrays.length>0&&angular.forEach(a.finalCategorizationArrays,function(c){if(c&&c.length>0){var d=_.deepPluck(c,"properties.label"),e=d.join(" : ");b[e]||(b[e]=[]),b[e].push(a)}})});var c=[];return angular.forEach(b,function(a,b){c.push({text:b,title:!0}),angular.forEach(a,function(a){c.push({text:a.controlLabel+" : "+a.control.properties.label,title:!1})})}),c}function k(a,b,d,e){var f=h(a),g=f.diagnoseData[b];console.log("edit diagnose",f,g),g.selectedControlsDetails=angular.copy(d),g.categoriesArray=j(g.selectedControlsDetails),g.imageCollectionHolder=e,c.setValue("ClientDataServiceValues",r)}function l(a,b){var c=h(a),d=c.diagnoseData[b];return d}function m(a,d,e,f){var g=h(a),i=g.diagnoseData[d];i.selectedControls=e,i.categoriesArray=j(e);var k=b.getControls();angular.merge(i.diagnose,k),o(""),o("*"),c.setValue("ClientDataServiceValues",r)}function n(a,b){var d=h(a);d.diagnoseData.splice(b,1),c.setValue("ClientDataServiceValues",r)}function o(a){if(a||(a=r.filterText),"*"===a)return r.filteredData.splice(0,r.filteredData.length),r.filteredData.push.apply(r.filteredData,r.clientsData),r.filteredData;if(""===a)return r.filteredData.splice(0,r.filteredData.length),r.filteredData;var b=_.filter(r.clientsData,function(b){return-1!==b.clientName.search(a)});return r.filteredData.splice(0,r.filteredData.length),r.filteredData.push.apply(r.filteredData,b),r.filteredData}var p={},q={clientId:-1,clientName:"",clientAge:"",birthdateAndHour:"",clientGender:"",clientPhone:"",clientAddress:"",clientEmail:""},r={selectedClient:q,clientsData:[],nextClientId:0,filterText:"",filteredData:[]};return p.initialize=d,d(),p.getValues=e,p.addClient=f,p.deleteClient=g,p.getClientById=h,p.addDiagnose=i,p.prepareCategorizationArray=j,p.editDiagnose=k,p.getClientDiagnose=l,p.updateEditedDiagnose=m,p.deleteDiagnose=n,p.filter=o,p}angular.module("client-module").service("ClientDataService",a),a.$inject=["$rootScope","DiagnoseDataTransferService","DBService"]}();
//# sourceMappingURL=ClientDataService.js.map
/* Min file (c) */
!function(){function a(){var a={restrict:"E",templateUrl:"AppCode/ClientModule/SearchClientTemplate.html",controller:c};return a}function b(a){var b={restrict:"A",link:function(b,c,d){$(c).listview(),b.$watchCollection("model.clientDataServiceValues.filteredData",function(a,b){$(c).listview("refresh").trigger("updatelayout")}),c.on("filterablebeforefilter",function(c,d){console.log(a.filter()),b.$apply()})}};return b}function c(a,b){var c=a.model={};c.searchText="",c.clientDataServiceValues=b.getValues(),a.onFetchAllClientData=function(){b.filter("*")},a.onClearClientData=function(){b.filter("")}}angular.module("client-module").directive("searchClient",a).directive("searchAutocomplete",b).controller("SearchClientController",c),b.$inject=["ClientDataService"],c.$inject=["$scope","ClientDataService"]}();
//# sourceMappingURL=SearchClientDirective.js.map
/* Min file (c) */
!function(){function a(){var a={restrict:"E",templateUrl:"AppCode/ClientModule/ClientDetailsTemplate.html",scope:{details:"=",index:"="},link:function(a,b,c){b.enhanceWithin()},controller:b};return a}function b(a,b,c){a.onAddDiagnose=function(){c.$emit("ClientDetailsDirective.onAddDiagnose",{clientId:a.details.clientId}),DiagnoseTabFunctionality.makeActive()},a.onDeleteClient=function(a){b.deleteClient(a),b.filter()}}angular.module("client-module").directive("clientDetails",a).controller("ClientDetailsController",b),b.$inject=["$scope","ClientDataService","$rootScope"]}();
...
/* Min file (c) */
"use strict";!function(){function a(a,b,c){function d(){return m}function e(){b.getValue("ClientDiagnoseDataServiceValues").then(function(a){a&&angular.forEach(a,function(a,b){m[b]=a})})}function f(a){return m[a]}function g(a,c){m[a]=c,b.setValue("ClientDiagnoseDataServiceValues",m)}function h(a,b,c,d){}function i(a){m.clientId=a}function j(b,c){a.updateEditedDiagnose(m.clientId,m.diagnoseIndex,b,c)}function k(b){var d=a.getClientDiagnose(m.clientId,b),e={selectedControlsDetails:d.selectedControlsDetails,imageCollectionHolder:d.imageCollectionHolder,actionTrackerInfo:{clientId:m.clientId,diagnoseIndex:b}};c.$emit("ClientDiagnoseDataService.editDiagnose",e),DiagnoseTabFunctionality.makeActive()}var l={},m={};return l.getValues=d,l.initialize=e,l.getClientDiagnose=f,l.setClientDiagnose=g,l.addDiagnose=h,l.setClientId=i,l.updateEditedDiagnose=j,c.$on("DiagnoseDataService.saveClientDiagnose",function(b,c){console.log("DiagnoseDataService.saveClientDiagnose",b,c);var d=c.selectedControlsDetails,e=c.imageCollectionHolder;if(c.isAddDiagnose===!0)a.addDiagnose(m.clientId,d,e);else{var f=c.actionTrackerInfo.clientId,g=c.actionTrackerInfo.diagnoseIndex;console.log("clientDiagnose: ",d,e),a.editDiagnose(f,g,d,e)}}),c.$on("ClientDetailsDirective.onAddDiagnose",function(a,b){m.clientId=b.clientId}),l.editDiagnose=k,l}angular.module("client-module").service("ClientDiagnoseDataService",a),a.$inject=["ClientDataService","DBService","$rootScope"]}();
...
/* Min file (c) */
"use strict";!function(){function a(a){var c={restrict:"E",templateUrl:"AppCode/ClientModule/DiagnoseDetailsTemplate.html",scope:{diagnoseData:"=",clientId:"="},link:function(b,c,d){a(function(){$(c).enhanceWithin()},1),b.$watch("diagnoseData",function(){a(function(){$(c).enhanceWithin()},1)},!0)},controller:b};return c}function b(a,b,c){a.onEditDiagnose=function(b){c.setClientId(a.clientId),c.editDiagnose(b)},a.onDeleteDiagnose=function(c){b.deleteDiagnose(a.clientId,c)}}angular.module("client-module").directive("diagnoseDetails",a).controller("DiagnoseDetailsController",b),a.$inject=["$timeout"],b.$inject=["$scope","ClientDataService","ClientDiagnoseDataService"]}();
//# sourceMappingURL=DiagnoseDetailsDirective.js.map
/* Min file (c) */
"use strict";!function(){function a(){var a={};return a}angular.module("client-module.data-transfer",["client-module"]).service("ClientDataTransferService",a)}();
//# sourceMappingURL=ClientDataTransferService.js.map
/* Min file (c) */
!function(){"use strict";function a(a,b,c,d,e,f){var g=this,h=g.model={};g.initialize=function(){b.initialize(),h.serviceValues=b.getValues()},g.initialize(),e.$on("ClientDiagnoseDataService.editDiagnose",function(b,d){console.log("ClientDiagnoseDataService.editDiagnose",b,d);{var e=d.selectedControlsDetails;d.imageCollectionHolder}c.setIsControlsValuesBeingSet(!0),a.setIsAddDiagnose(!1),a.setActionTrackerInfo(d.actionTrackerInfo),a.setControlsValues(e);var g=0,h=!1,i=f.$watch(function(){h||(h=!0,f.$$postDigest(function(){h=!1,g++<1?setTimeout(function(){FunctionalityModule.enhancePage()},1):(i(),c.setIsControlsValuesBeingSet(!1))}))})}),g.onSaveDiagnoseItemsData=function(){var b=d.getSelectedControls();a.processSelectedControls(b),ClientTabFunctionality.makeActive()}}angular.module("diagnose-module",["diagnose-module.data-transfer","selected-controls-module","data"]).controller("DiagnoseController",a),a.$inject=["DiagnoseDataService","DiagnoseDataTransferService","SharedDataService","SelectedControlsService","$rootScope","$scope"]}();
//# sourceMappingURL=DiagnoseController.js.map
/* Min file (c) */
"use strict";!function(){function a(a,b,c,d){function e(){return s}function f(a){s.isAddDiagnose=a}function g(a){s.actionTrackerInfo=a}function h(){0==s.isAddDiagnose&&(s.isAddDiagnose=!0)}function i(b){angular.forEach(b,function(a,b){a.finalCategorizationArrays=[],a.categoriesIdsArray=[];var c=a.categoriesInfo;angular.forEach(c,function(b,c){if(b.properties.value===!0){var d=[];j(b,d,a)}})});var c,e=a.getControls();e&&(c=r.constructImageCollectionHolder(e)),console.log("serviceValues.isAddDiagnose : ",s.isAddDiagnose),d.$emit("DiagnoseDataService.saveClientDiagnose",{selectedControlsDetails:b,imageCollectionHolder:c,isAddDiagnose:s.isAddDiagnose,actionTrackerInfo:s.actionTrackerInfo}),s.actionTrackerInfo=null,h(),r.resetControls(b),r.resetCategories(b)}function j(a,b,c){if(a&&a.properties.value){if(c.categoriesIdsArray.push(a.properties.id),b.push(a),void 0===a.categorieschildren)return c.finalCategorizationArrays.push(angular.copy(b)),void b.splice(b.length-1,1);var d=!1;if(angular.forEach(a.categorieschildren,function(a,b){a.properties.value&&(d=!0)}),!d)return c.finalCategorizationArrays.push(angular.copy(b)),void b.splice(b.length-1,1);angular.forEach(a.categorieschildren,function(a,d){j(a,b,c)})}}function k(a){var b=[];return angular.forEach(a[0].children,function(a,c){"useAsWebCamTab"===a.diagnoseTabChoice&&a.imageValues.imagesCollection&&b.push(angular.copy(a.imageValues.imagesCollection))}),b}function l(b){var d=a.getControls();angular.forEach(b,function(a,b){var c=m(d,b);c.value=a.value,angular.forEach(a.categoriesIdsArray,function(a,b){var d=n(c.categorieschildren,a);d.properties.value=!0})}),c.setSelectedControls(b)}function m(a,b){for(var c=0;c<a.length;c++){var d=a[c];if(d.properties.id===b)return d;if(d.children){var e=m(d.children,b);if(e)return e}}}function n(a,b){for(var c=0;c<a.length;c++){var d=a[c];if(d.properties.id===b)return d;if(d.categorieschildren){var e=n(d.categorieschildren,b);if(e)return e}}}function o(a){angular.forEach(a,function(a,b){a.value=!1,a.control&&angular.isDefined(a.control.value)&&(a.control.value=!1)})}function p(a){angular.forEach(a,function(a,b){var c=a.categoriesInfo;angular.forEach(c,function(a,b){q(a)})})}function q(a){a&&a.properties.value===!0&&(a.properties.value=!1,void 0!==a.categorieschildren&&angular.forEach(a.categorieschildren,function(a,b){q(a)}))}var r={},s={isAddDiagnose:!0,actionTrackerInfo:null};return r.getValues=e,r.setIsAddDiagnose=f,r.setActionTrackerInfo=g,r.processSelectedControls=i,r.constructImageCollectionHolder=k,r.setControlsValues=l,r.fetchCategory=n,r.resetControls=o,r.resetCategories=p,r}angular.module("diagnose-module").service("DiagnoseDataService",a),a.$inject=["DiagnoseDataTransferService","SharedDataService","SelectedControlsService","$rootScope"]}();
//# sourceMappingURL=DiagnoseDataService.js.map
/* Min file (c) */
"use strict";!function(){function a(a){function b(){a.getValue("DiagnoseDataTransferService").then(function(a){a&&(h.controls=a.controls)})}function c(){return h.controls}function d(a){h.controls=a,e()}function e(){a.setValue("DiagnoseDataTransferService",h)}function f(){return h}var g={},h={controls:null};return g.initialize=b,g.getControls=c,g.setControls=d,g.persistData=e,g.getValues=f,g}angular.module("diagnose-module.data-transfer",["db-module"]).service("DiagnoseDataTransferService",a),a.$inject=["DBService"]}();

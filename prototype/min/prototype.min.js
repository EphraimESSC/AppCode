...
function createDirective(name) {
  ...
  DirectiveClass.$inject = [ '$compile', '$templateCache', 'DirectiveHelperService', 'Data'];

  function DirectiveClass($compile, $templateCache, DirectiveHelperService, Data) {
    return {
      restrict: 'E',
      scope : {
        controls: "=",
      ...
      compile: function(tElem, tAttrs){
        ...
        return {
          pre: function(scope, iElem, iAttrs){
            ...
            if (angular.isDefined(scope.tabHierarchyHeadings)) {

              Data.tabHierarchyHeadings = scope.tabHierarchyHeadings;
            }
            ...
            if (scope.controls.type === "TabRoot") {
              template = $templateCache.get("Tabs");
            }

            if (scope.controls.type === "RadioGroup") {
              DirectiveHelperService.processHierarchyLabelsForControl(scope.controls, scope.parent);
              processRadioGroup(scope, Data);
            }

            if (scope.controls.type === "CheckboxGroup") {
              DirectiveHelperService.processHierarchyLabelsForContainer(scope.controls, scope.parent);
            ...
            if (scope.controls.type === "Checkbox") {
              DirectiveHelperService.processHierarchyLabelsForControl(scope.controls, scope.parent);
              processCheckbox(scope, Data, iElem);
            }

            if (scope.controls.type === "TextInput") {
              DirectiveHelperService.processHierarchyLabelsForControl(scope.controls, scope.parent);
              processTextInput(scope, Data);
            }

            if (scope.controls.type === "Text") {
              Data.TextLabel = scope.controls.properties.text;
              scope.controls.properties.label = scope.controls.properties.text;
            }

            if (scope.controls.type === "ToggleSwitch") {
              processToggleSwitch(scope, Data);
            }

            if (scope.controls.type === "Slider") {
              processSlider(scope, Data, iElem);
            }
            ...
            if (scope.controls.type === "SelectMenu") {
              processSelectMenu(scope, Data, iElem);
            }

            if (scope.controls.type === "Collapsible") {
              DirectiveHelperService.processHierarchyLabelsForContainer(scope.controls, scope.parent);
            }
          ...
          post: function(scope, iElem, iAttrs){
            ...
            setTimeout(function(){
              /*if (scope.controls.type === "Checkbox") {
                ...
                //$(iElem).find('input').checkboxradio();
              }*/

              if (scope.controls.type === "Tabs" || scope.controls.type === "TabRoot") {
                if (scope.controls.type === "TabRoot") {
